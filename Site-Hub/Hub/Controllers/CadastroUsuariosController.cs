...
namespace Hub.Controllers
{
    public class CadastroUsuariosController : Controller
    {
        ...
        public CadastroUsuariosController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Nome,DataNascimento,Email,senha,Cargo,Pronome,Id")] CadastroUsuario cadastroUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,DataNascimento,Email,senha,Cargo,Pronome,Id")] CadastroUsuario cadastroUsuario)
        {
